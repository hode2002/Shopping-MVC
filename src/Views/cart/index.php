        ...
        <div class="row py-1">
            <div class="product d-flex justify-content-center col-6 col-md-4 col-lg-2 py-2">
                <div class="card" style="width: 11rem">
                    <img src="https://down-vn.img.susercontent.com/file/vn-11134207-7r98o-llysbdiyaktb13_tn" class="card-img-top p-2" alt="product" />
                    <div class="card-body p-2">
                        <h5 class="card-title text-truncate" style="font-size: 11px">
                            Tai Nghe Bluetooth Pro 2 Không Dây Cao Cấp Định Vị Đổi Tên Tự
                            Động Kết Nối Cảm Ứng Chính Hãng PKT
                        </h5>
