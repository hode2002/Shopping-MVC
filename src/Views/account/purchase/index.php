        ...
        <div class="row h-100 py-5">
            ...
            <div class="col-12 col-md-9 p-5 bg-white h-100 rounded-3">
                <div class="p-3 d-flex align-items-center justify-content-between fw-semibold overflow-x-scroll mb-3" style="background-color: white;">
                    ...
                    <p data-status="0" class="btn-status px-5 text-center text-nowrap text-decoration-none text-dark p-2 rounded">Chờ
                        xác nhận</p>
                    <p data-status="1" class="btn-status px-5 text-center text-nowrap text-decoration-none text-dark p-2 rounded">Vận
                        chuyển</p>
                    <p data-status="3" class="btn-status px-5 text-center text-nowrap text-decoration-none text-dark p-2 rounded">Hoàn
                        thành</p>
                    <p data-status="2" class="btn-status px-5 text-center text-nowrap text-decoration-none text-dark p-2 rounded">Đã
                        Hủy</p>
                </div>
...
<script>
    ...
    const renderOrder = (orders = []) => {
        ...
        orders.forEach(order => {
            let html = `<div class="order shadow text-center p-4 mb-5" style="background-color: white;" data-order_id="${order.id}" data-shop_id="${order?.products[0]?.shop_id}">
                            <div class="d-flex justify-content-between mt-3 mb-1 align-items-center">
                                <a href="#" class="text-start text-decoration-none text-dark">
                                    ...
                                    <span class="text-capitalize">${order?.products[0]?.shop_name}</span>
                                </a>
            ...
            html += `
                    <div class="mt-3 mb-4 d-block d-md-flex justify-content-between align-items-end flex-wrap">
    ...
    $(document).on('click', '.cancelBtn', function() {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                const shopId = order[0].dataset.shop_id;
